...
@section ('title-body', 'Ubah Konfigurasi Penghasilan')
...
<div class="col-md-8 mx-auto">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.penghasilan.update', ['id' => $penghasilan->id]) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12">
                        ...
                        <select class="custom-select" name="idHarga" required>
                            ...
                            <option value="{{ $item->id }}" {{ ($penghasilan->idHarga == $item->id)? 'selected' : '' }}>{{ $item->tingkat }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        <label>Point</label>  
                        <input type="number" name="point" class="form-control" value="{{ $penghasilan->point }}" required autocomplete="off">
                        @if ($errors->has('point'))
                        <span class="text-danger">
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" name="fee" class="form-control" value="{{ $penghasilan->fee }}" required autocomplete="off">
                        @if ($errors->has('fee'))
                        <span class="text-danger">
