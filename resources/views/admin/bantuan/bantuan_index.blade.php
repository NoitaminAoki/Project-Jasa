		...
		<div class="accordion" id="accordionExample">
			@foreach ($support as $bantuan)
			    ...
			    <div class="card-header" id="heading{{ $bantuan->id }}">
			      <h2 class="mb-0">
			        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse{{ $bantuan->id }}" aria-expanded="true" aria-controls="collapse{{ $bantuan->id }}">
			          Dari Pengirim Dengan Email <br class="d-block d-md-none"> {{ $bantuan->email }}
			        </button>
			      </h2>
			    </div>
			    <div id="collapse{{ $bantuan->id }}" class="collapse show" aria-labelledby="heading{{ $bantuan->id }}" data-parent="#accordionExample">
			      <div class="card-body">
