<div class="sidebar mySimpleBar"  data-simplebar data-simplebar-auto-hide="true">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{ (Storage::exists(Auth::guard('member')->user()->profile_picture))? Storage::url(Auth::guard('member')->user()->profile_picture) : asset('dist/img/avatar5.png') }}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
